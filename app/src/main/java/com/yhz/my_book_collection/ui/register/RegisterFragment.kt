...
import com.yhz.my_book_collection.databinding.FragmentRegisterBinding
...
class RegisterFragment : Fragment() {
    ...
    private fun performRegister() {
        ...
        if (email.contains("@") && password.length >= 6) {
            // Save login state (auto-login after registration)
            ...
            Toast.makeText(context, "Invalid email or password must be at least 6 characters", Toast.LENGTH_SHORT).show()
        }
    }
